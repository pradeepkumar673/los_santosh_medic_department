...
export default function Sidebar() {
  ...
  return (
    <>
      ...
      <aside
        className={clsx(
          "fixed z-40 flex h-screen flex-col border-r border-slate-200 bg-white transition-all duration-200",
      ...
      >
        <div className="flex h-16 items-center justify-between border-b border-slate-100 px-4">
          <div className="flex items-center gap-2 overflow-hidden">
            ...
            {!isSidebarCollapsed && <span className="truncate text-lg font-bold text-slate-800">MediQueue AI</span>}
          </div>
        ...
        <div className="border-t border-slate-100 p-3">
          ...
          <button
            ...
            className="mt-1 hidden w-full items-center justify-center rounded-lg p-2 text-slate-400 hover:bg-slate-50 lg:flex"
          >
